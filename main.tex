...
% OK - un mot sur Derrida pour la grammatologie 
% ajouter Dudas, Rebelo dans les artistes
% OK - ceci n'est pas un son (fig 5.1), la légende est bof
% OK - figure 5.2 n'est pas référencée
...
% converts all @miscs with a URL field to @online, so that online resources have url in reference
% see https://tex.stackexchange.com/questions/428959/get-biblatex-to-show-url-for-webpage-references
% \DeclareSourcemap{
...
% highliht in redthings that should be removed or adjusted
...
% Point médian (légèrment abaissé)
...
\setcounter{tocdepth}{5}		% define depth of toc
