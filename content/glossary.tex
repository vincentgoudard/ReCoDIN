...
{
    name={ACROE},
    description={\textit{\glsentrylong{ACROE}}: créée en 1976 par Claude Cadoz, Jean-Loup Florens et Annie Luciani à l’Institut National Polytechnique de Grenoble, avec le soutien du ministère de la Culture, l'ACROE a mené des travaux scientifiques, technologiques et artistiques et pédagogiques, dans le secteur des arts multisensoriels numériques. Elle a élaboré plusieurs outils de création artistique dont le paradigme central est la situation instrumentale, notamment le système \gls{CORDIS-ANIMA}},
