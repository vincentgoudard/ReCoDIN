...
\begin{figure}[!htbp]
	\makebox[\linewidth][c]{%
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du son au musicien}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{De l'instrument au musicien}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du musicien au musicien}
		\end{subfigure}%
	}\\
	\makebox[\linewidth][c]{%
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du musicien au son}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{De l'instrument au son}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du son au son}
		\end{subfigure}%
	}\\
	\makebox[\linewidth][c]{%
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du musicien à l'instrument}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du son à l'instrument}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{De l'instrument à l'instrument}
		\end{subfigure}%
	}\\
	\makebox[\linewidth][c]{%
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du musicien/son à l'instrument}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du musicien/instrument au son}
		\end{subfigure}%
		\hspace{.1\linewidth}
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{De l'instrument/son au musicien}
		\end{subfigure}%
	}\\
	\makebox[\linewidth][c]{%
		\begin{subfigure}[b]{.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{gfx/03_gesture/gesture-inference-a.pdf}
			\caption{Du musicien/son/instrument à soi-même}
		\end{subfigure}%
	}
