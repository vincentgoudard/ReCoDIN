...
Comme nous l'avons dit précédemment, la relation de causalité entre le geste et le son dans les \glspl{DMI} n'est pas une donnée intrinsèque 

\noindent Nous avons vu dans les sections précédentes différents aspects concernant la fonctionnalité du geste, considérée du point de vue de l'instrumentiste. Ce point de vue a tendance à privilégier la recherche d'une relation lisible et cohérente entre le geste et le son, se situant à l'intersection où il y a correspondance entre les actions réalisés par l'instrumentiste, les actions effectivement captés par l'interface et le résultat désiré de ces actions (cf. figure \ref{fig:benford_expected-sensed-desirered}).

\indent La recherche d'une interaction transparente (cf. \cite{Fels}) pour l'instrumentiste, comme condition nécessaire à l'expressivité d'un instrument, a eu tendance a masquer le fait que la relation entre le musicien et son public n'est pas uniquement basée par la recherche de cette transparence. La musique est un art du mirage, de l'illusion (comme le rappelle Risset dans la citation en exergue de ce chapitre) dans lequel la subversion se substitue à la transparence pour dessiner de nouvelles relations du sensible. Ainsi le musicien créé des continuités là où il y a discontinuité (e.g. le \textit{legato} sur des notes de piano, la modulation tonale pour passer d'un mode à un autre, la fusion des timbres dans le travail d'orchestre, etc.),  et inversement introduit des ruptures pour déjouer les attentes du public (e.g. les jeu de contre-temps rythmiques, les \textit{subito-pianos}, etc.).
