...
\indent Précisons ici que l'intérêt de subvertir le système des valeurs sur lesquelles la musique s'appuie ne se limite pas à une duperie du spectateur-auditeur qui se trouverait victime d'une farce, mais de permettre l'extrapolation du réel dans un espace imaginaire, en y ouvrant une brèche qui permet en retour de le rendre tangible.
...
\begin{itemize}[noitemsep]
	...
	\item{\textbf{de l'instrument}}, la perception conjointe des gestes du musicien et du résultat sonore sur un instrument dont on ne connait pas \textit{a priori} le fonctionnement entraine une inférence de son fonctionnement. Par exemple, l'interprétation de la pièce \textit{Hangsimogato N°2} de György Kurtág Jr.\footnote{Vidéo disponible sur \url{https://youtu.be/MJ8Z5skovLw}.} laisse imaginer plusieurs scénarios possibles d'interaction instrumentale, les gestes procédant à la fois au déclenchement des sons et à leur accompagnement.
...
\end{itemize}
d'un fonctionnement supposé de l'instrument sur la base des gestes observés et du résultat sonore d'une part, et par suite, des gestes réalisés sur la base du fonctionnement supposé de l'instrument et du résultat sonore d'autre part (cf. figure \ref{fig:gesture:InferenceOnInstrument} et \ref{fig:gesture:InferenceOnGestures})
