...
\noindent Une première manière de subvertir la relation instrumentale consiste à laisser croire au public qu'il comprend la relation instrumentale (qui se situerait donc dans le plan du fond de la figure \ref{fig:gesture:expressive-space}), alors qu'elle diffère en réalité de la perception qu'il en a (et se situe dans le plan avant de la figure \ref{fig:gesture:expressive-space}).
