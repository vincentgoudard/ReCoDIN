...
\todo{Pierre : italiques à voir ? Cf règles typographiques.}
...
\todo{Pierre : je doute qu'il y ait beaucoup de gestes non-intentionnels chez le musicien !}
...
\todo{Pierre : l'exemple choisi devrait être un peu plus analyser car les mouvements du DJs sont probablement totalement intentionnels - c-a-d ils font partie du spectacle car le DJ se sait regardé.}
\todo{Pierre : je crois plus en la séparation geste-signe et geste-action}
...
\todo{Pierre : "image-de-son" : à développer mais attention, c'est assez hard à comprendre !}
...
\todo{Pierre : propos très discutables -> ce que tu sembles dire ensuite mais ce n'est pas très clair...}
...
\todo{Pierre : SI : beaucoup d'œuvres mixtes utilisent des systèmes de pédales ou des musiciens derrière des clavier MIDI pour assurer la synchro.}
...
\todo{Pierre : voir les 2 définitions de la musique}
...
\todo{Pierre : ce n'est pas seulement le cas de la musique mais aussi de la parole. Voir définition de Castellengo.}
\todo{Pierre : Cage -> référence ?}
...
\todo{Pierre : si tu parles de gestalt, il faut développer mais c'est aussi une théorie très controversée, donc attention !}
