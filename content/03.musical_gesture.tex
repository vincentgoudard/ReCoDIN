...
Ce modèle dépend de l'interface, mais aussi (surtout), du modèle sous-jacent à l'interface. Ainsi, si les gestes des doigts du pianistes sont assimilés aux gestes d'excitation sur un piano, 
