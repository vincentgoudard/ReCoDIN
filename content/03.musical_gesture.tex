...
\Pierre{Sorbonne Université sans tiret}
...
\Pierre(Peut-être faudrait-il aussi définir la différence entre 'geste' et 'mouvement' si tenté qu'il y en ait une}
...
\Pierre{Ce n'est pas ainsi que j'interprète le texte de Cadoz. Pour moi, il pense que l'ordinateur seul ne peut être un instrument, mais l'ordinateur + une interface (ce qu'il fait lui-même) : oui. Il ne dit pas que les appareils électronique ne sont pas des instruments.}
...
\Pierre{Il manque le début du paragraphe}
...
\Pierre{Spectromorphologie a-t-il à voir avec celui qui est développé par Denis Smalley (qui je pense est l'inventeur du terme) ?)
...
\Pierre{On est en plein dans le théâtre musical)
