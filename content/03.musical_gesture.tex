...
\indent Nous allons voir dans ce chapitre comment le geste instrumental s'en trouve affecté, par un examen critique des catégories gestuelles déjà proposées, et la proposition de nouvelles catégories prenant en compte l'aspect subversif de l'art musical.
...
Les études sur le geste musical et le geste instrumental s'accordent, elles, à le définir comme l'association d'un mouvement et d'une intention. 
...
Toutefois, son analyse diffère selon qu'on l'aborde du point de vue du mouvement pur, de celui de l'intention qu'il porte, ou de sa perception et son interprétation en tant que geste.
...
L'étude des fonctions du geste musicale par Claude Cadoz et Marcello Wanderley offre un cadre très riche et informatif pour l'analyse du geste instrumental sur les instruments acoustiques, et cet article abondamment citée s'est établi comme une référence sur cette question.
Curieusement, alors que la catégorisation fonctionnelle du geste s'appuyait sur une analyse des instruments acoustiques, elle a été prise comme modèle pour le design de l'interaction des \glspl{DMI} (e.g. \cite{arfib_strategies_2002}, \cite{schwarz_sound_2012}), alors même que ses auteurs précisent :
\iquote{Considering the context of traditional musical instruments, two facts can be initially remarked: 1) the need for instrument stability during the performance and 2) the existence of an energy continuum between the gesture and the perceived phenomena.}\cite{cadoz_gesture_2000}
Or, ces deux aspects sont mis en défaut dans le cas des instruments numériques : le continuum energétique est rompu et les instruments sont sujets à des possibles reconfigurations dynamiques. 

Cette relation pluri-millénaire étant cassée, le premier élan (et celui de Claude Cadoz en particulier) a été de tenter de la recréer artificiellement par systèmes de capteurs, d'actioneurs et des stratégies de mapping servant la définition de cette relation. Ces recherches ont notamment abouti au système Cordis-Anima, pionnier en matière de retour d'effort et de synthèse par modèle physique, qui n'a malheureusement pas connu une grande utilisation hors du laboratoire.

On peut cependant se demander dans quelle mesure ce cadre de référence est adapté à la question des relations geste-son dans les DMI.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Limites d'une analyse des \glspl{DMI} comme d'\gls{IHM}}
...
%-------------------------------------------
\subsection{Le geste et le son comme métaphores}
