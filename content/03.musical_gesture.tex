...
\begin{figure}[!htbp]
	...
	\centering
	\begin{minipage}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{gfx/03_gesture/Fels-transparency.pdf}
		\caption{Transparence pour le musicien et l'auditoire, d'après \cite{fels_mapping_2002}}
		\label{fig:gesture:fels_transparency}
	\end{minipage}
	\hspace{.02\linewidth}
...
\begin{figure}[!htbp]
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\caption[Inférence du fonctionnement de l'instrument]{Inférence du fonctionnement de l'instrument}
		\label{fig:gesture:InferenceOnInstrument}
	\end{minipage}
	\hspace{.02\linewidth}
	\begin{minipage}[t]{0.48\textwidth}
		\includegraphics[width=\linewidth]{gfx/dummy.pdf}
		\caption[Inférence des gestes réalisés]{Inférence des gestes réalisés}
		\label{fig:gesture:InferenceOnGestures}
	\end{minipage}
\end{figure}
%---- Figure : gesteReelGesteSuppose --------
