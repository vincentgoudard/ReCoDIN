...
La définition du geste musicale pose le double problème de définir ce qu'on entend pas ``geste'' et par ``musique''. Pour ce qui est de la musique, j'adopterai ici la définition donnée par Christopher Small, non pas du nom ``musique'', mais du verbe ``musiquer'' \cite{small_musicking:_1998}:

\iquote{Musiquer, c'est participer, à quelque titre que ce soit, à une performance musical, que ce soit en jouant, en écoutant, en répétant ou en pratiquant, en fournissant du matériel pour la performance (ce qu'on appelle ``composer''), ou en dansant. Nous pourrions même parfois en étendre le sens à ce que fait la personne qui prend les billets à l'entrée ou aux gros bras qui déplacent le piano et les tambours ou les roadies qui installent les instruments et font les balances ou les personnes qui nettoient après que tout le monde soit parti. Ils contribuent tous, eux aussi, à la nature de l'événement qu'est une performance musicale.}

Si j'adopte cette définition, ce n'est pas pour l'exhaustivité que semble conférer une définition aussi large mais essentiellement pour deux raisons: la première est le choix d'utiliser un verbe plutôt qu'un nom, c'est à dire d'identifier une pratique plutôt qu'un objet, ce qui dans le cas de la performance musicale semble plus adapté. La deuxième raison est liée au contexte technico-culturel dans lequel ces pratiques s'inscrivent: la reconfiguration des modes de production et de réception de la musique\footnote{voir le travail de xxx todo Auslander, Paul Théberge \cite{theberge_any_1997}} qu'ont entrainé les évolutions technologiques du XXème siècle ont rendu poreuses les frontières entre les différentes pratiques liées à la création musicale. Je restreindrai toutefois le champ de cette définition aux pratiques qui gravitent directement autour de l'instrument de musique.

Partant de cette définition, et à la suite d'une proposition d'Hugues Genevois dans \cite{genevois_geste_1999}, on peut distinguer plusieurs phases au cours desquelles se manifeste un geste musical (qui pourra se manifester à travers diverses formes de lutheries):
...
Stiegler développe le concept de ``gramme'' comme \iquote{corps organisé de signes et de symboles} et emprunte à Sylvain Auroux \cite{auroux_revolution_1994} le concept de ``grammatisation'' comme \iquote{le processus par lequel le continuum temporel des comportements humains est transformé en un spatial discret, qui permet de les intégrer dans les outils}. Ainsi de l'informatique qui dissocie en symboles et en catégories discretes ce qui est continu et intégré dans le geste, comme dans le son.
