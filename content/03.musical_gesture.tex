...
L'étude du geste a vraiment commencé au milieu du XXème siècle et a progressivement gagné en importance, jusqu'à devenir un domaine d'étude à part entière, les \textit{gesture studies}, soutenue notamment par l'\gls{ISGS}\footnote{\url{http://gesturestudies.com}} créée en 2002.
%-------------------------------------------
...
\begin{wrapfigure}{R}{0.5\textwidth}
	...
	\label{fig:interface:fels_transparency}
\end{wrapfigure}
...
\textbf{Le geste de résonance} : qui associe à la fois une fonction ergotique (de type modulation) et une fonction épistémique (en cela qu'on cherche le \textbf{sweet spot}). 
