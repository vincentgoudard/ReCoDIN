...
Il existe par ailleurs des mouvements produits par la machine, que cela soit sous forme d'enregistrements (samples, courbes d'automation (cf. Figure \ref{fig:gesture:automation}), etc.) ou de processus algorithmiques génératifs. Si toutefois la définition du geste implique que le mouvement soit associé à une intention, on ne peut prêter une intention à la machine qu'à travers la ``programmation'' de ce mouvement machinique par le luthier numérique.
...
\textbf{Extra notes}\\
Enrique Tomás- tangible score \cite{tomas_tangible_2014}\\
Cette notion de geste programmé fait écho à la notion d'instrument composé par Battier et Schnell. \cite{schnell_introducing_2002}\\
...
Dans le cas de l'instrument acoustique, le système est passif et la re-sonance est pure résonance acoustique dans la mesure où l'instrumentiste agit sur les modes acoustiques qui conditionne la durée de vie (ou d'extinction, selon la persepctive adoptée) du son. \\
