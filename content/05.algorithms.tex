...
\begin{itemize}[noitemsep]
	...
	\item \textbf{être dynamique}, c'est à dire à la fois être susceptible d'évolution temporelle, mais également, de manière plus radicale, être instancié, supprimé, remplacer par un autre en cours de jeu.
