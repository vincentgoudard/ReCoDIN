...
%------------------ Figure : ceci n'est pas un son ---------------------
 \begin{figure}[!htbp]
 	...
 	\caption[L'image d'un son n'est pas un son]{L'image d'un son n'est pas un son: les sons enregistrés sur un ordinateur sont des onnées numériques utilisables dans des modèles complexes, des gestes programmés.}
