...
\end{figure}
%------------------ Figure : FIBR-Voronoi ---------------------
\indent Les données numériques sont à la fois extrêmement diverses en terme de contenu (son, image, texte, vidéo, structure, processus, etc.) et extrêmement uniformes en terme de représentation (une séquence de 0 et de 1). Cette uniformité de la représentation numérique permet de stocker ces diverses informations sur des supports identiques, de les transmettre sur les mêmes câbles, mais également de leur appliquer les mêmes processus de traitement\footnote{Par exemple, lire un fichier PDF comme s'il s'agissait d'un son, comme dans la composition audiovisuelle \textit{107724404x8}: \url{https://vimeo.com/242484484}}.\\
