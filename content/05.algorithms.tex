...
Les informations digitalisées sont à la fois extrêmement diverses en terme de contenu et extrêmement uniformes en étant toutes représentées par un encodage numérique.
