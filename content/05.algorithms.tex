...
\noindent Ce sont ces différents traitements, lorsqu'ils se cristallisent en des agencements identifiables, que l'on peut extraire sous forme d'un modèle abstrait ré-utilisable, que l'on nommera ici ``modèle intermédiaire dynamique''.
...
\subsection{Qualités recherchées dans les modèles intermédiaires dynamiques}
