...
% 	\caption[Utilisation d'un diagramme de Voronoï dans FIB\_R]{Capture d'écran d'un extrait de la performance FIB\_R. Un algorithme permettant le calcul d'un diagramme de Voronoï (simulant la coadaptation organique d'un réseau de cellules) a été adapté pour moduler le son.}
