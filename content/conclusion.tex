...
Dans ce contexte de modularisation extrême des fonctions de l'instrument, un besoin est de trouver les modes de resonances possible entre l'expressivité des gestes de l'instrumentiste et l'expressivité des gestes programmés de l'instrument. Cette résonance peut s'établir à l'aide de protocoles de communication 
