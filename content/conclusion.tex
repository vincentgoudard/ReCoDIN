...
Pour autant, l'image romantique du messie/auteur/star est peut-être aussi à relativiser. L'engouement autour d'une unique figure responsable de la création a des relents chrétiens qu'il ne faudrait pas croire trop universels.

J'ai souvent entendu cette question, empreinte d'une certaine nostalgie d'un bon vieux temps révolu (et me la suis probablement moi-même posée) de savoir qui était le nouveau Mozart, le nouveau Stravinski, le nouvel Elvis, les nouveaux Beatles, la nouvelle Janis, le nouveau Mickael Jackson, la nouvelle Björk, le nouveau Nick Cave, la nouvelle Beyoncé ... bref, le nouveau messie ou la nouvelle madonna révolutionnaire qui vient balayer l'ordre ancien. 
