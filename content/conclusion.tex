...
Dès à présent, nous commençons à en sentir la portée. La computabilité de cette aire organologique (TODO: RÉPÉTITION) la rend sujette à toutes les capacités que l'on peut attendre de la part de la machine: rapidité d'éxécution, optimisation, génération automatique, voire, nous promet-on aujourd'hui, l'invention pure et simple, à l'aide des ``grands modèles de langage''\footnote{``Large language models'' en anglais, ou ``LLM'', tels qu'utilisés par l'agent conversationel chatGPT}. 
