...
\end{figure}
%-------------------------- Figure : ONE ----------------------------------
\index[people]{delaubier@De Laubier, Serge}
\index[people]{couprie@Couprie, Pierre}
\index[people]{genevois@Genevois, Hugues}
\index[people]{bouckaert@Bouckaert, Laurence}
\index[people]{kurtagjr@Kurtág, György, Jr.}
\index[people]{haury@Haury, Jean}
\index[people]{goudard@Goudard, Vincent}
