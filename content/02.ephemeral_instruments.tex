...
%------------------ Figure : software update ---------------------
\begin{figure}[!htbp]
	\makebox[\linewidth][c]{%
		\begin{subfigure}[b]{.5\textwidth}
			\centering
			\includegraphics[width=.95\textwidth]{gfx/04_ephemeral/AbletonNotOptimised.png}
			\caption{Message de mise à jour d'Ableton Live}
		\end{subfigure}%
		\begin{subfigure}[b]{.5\textwidth}
			\centering
			\includegraphics[width=.95\textwidth]{gfx/04_ephemeral/AppleSoftwareUpdate.png}
			\caption{Message de mise à jour du système}
		\end{subfigure}%
	}
	\caption{Le dilemme sans fin de la mise à jour.}
\end{figure}

\todo{Pierre : éviter ce genre d'illustration car n'apporte rien de plus au discours.}
