...
\noindent Le premièr rapport avec l'instrument est visuel: avant même de sonner, l'instrument présente une structure spatiale, d'éventuels éléments reconnaissables, marqueurs, touches, poignées, symboles, etc. Ces aspects visuels sont présentés plus en détail dans le chapitre \ref{ch:visual_representation}.
