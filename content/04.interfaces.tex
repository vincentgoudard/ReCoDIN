...
\begin{itemize}[noitemsep]
	...
	\item \textbf{interfaces portatives}, qu'on peut \textit{prendre} et \textit{tenir} dans ses mains pour en jouer, mais également \textit{poser} (comme un ustensile), par exemple \textit{The Sponge} de Martin Marier\index[people]{marier@Marier, Martin}, un tambourin, un gamepad, un harmonica;
