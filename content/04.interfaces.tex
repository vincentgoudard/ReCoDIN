...
\noindent Les \glspl{DMI} en partie libérés\footnote{cf. § \ref{sec:interfaces:part_acoustique}} des contraintes de facteur de forme liées à l'acoustique, présente un agencement et une topologie procédant de questions ergonomiques d'une part mais aussi d'héritages, instrumentaux ou non. L'héritage le plus évident est celui des techniques de jeu et du répertoire, qui prend une importance considérable dans le design des \glspl{DMI} inspirés d'instruments pré-existants, en particulier les instruments dits augmentés (cf. Annexes \ref{appendix:mamou-mani} et \ref{appendix:turchet}}.\\
\indent Une autre forme d'héritage est l'héritage imaginaire, indirectement lié à l'instrument en question, mais porteur de souvenirs, d'une poésie, d'évocations qui dépasse le strict cadre fonctionnel de l'instrument mais polarise le jeu du musicien et l'écoute du public, \iquote{comme s'il y avait un arrière plan imaginaire de tout ce que ça draine d'histoire, de projections} (cf. interview en Annexe \ref{appendix:turchet}).\footnote{Voir également le documentaire sur l'Olitherpe de Patricia Dallio}
