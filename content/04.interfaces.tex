...
\section{Tecnhologies de capteurs}
Capteurs ``bruts'' et capteur ``intelligents''
Pads MIDI => peuvent être implémentés via interrupteurs, piezzo, FSR...
Multitouch = différentes technologies de détections (capcitives, infra-rouge, etc.) pour renvoyer la position des doigts.
