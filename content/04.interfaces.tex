...
\subsection{Brancher l'entrée sur la sortie}
...
\noindent\textbf{Repères statiques}\\
...
%------------ Figure : filigramophone et xypre piezo -----------
\noindent\textbf{Repères dynamiques : retours haptique et audiotactile}\\
...
\noindent\textbf{Vérouillage des composants GUI}\\
...
et la correpondance entre l'anatomie corporelle et celle de l'interface,
