...
e.g. Jordan Rudess, ``claviériste expert'' jouant du soundplane, du linnstrument
 ...
 Cette part incalculable dont parle Stiegler fait écho à la propension du geste à dépasser ses propres limites, non pas seulement sur le plan physique mais également sur le plan cognitif. (cf. exemple des musiques de Steve Reich, d'abord créées avec l'aide de machine, puis de manière humaine => piano phase solo)
%-------------------------------------------
...
A l'autre extrémité, la réception de la performance par le spectacteur/auditeur engage une projection active pour reconstruire du sens : déterminer la cause des sons, anticiper les trajectoires
