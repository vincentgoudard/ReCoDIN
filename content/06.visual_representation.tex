...
\indent D'autres manières d'intégrer le contexte de la performance dans la représentation visuelle de l'instrument est de modéliser son espace acoustique pour venir contrôler la spatialisation du son (cf. figure \ref{fig:visual_representation:spat}) ou --~à l'inverse~-- de projeter sur le lieu une représentation visuelle de la musique\footnote{ou une ``musique visuelle'' comme l'appelle Serge de Laubier} (cf. \ref{fig:visual_representation:pucemuse-monument}).
