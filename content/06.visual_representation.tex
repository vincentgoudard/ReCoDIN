...
% 	\begin{center}
% 		\includegraphics[width=0.4\textwidth]{gfx/06_visual_representation/Xypre-Live.jpg}
% 	\end{center}
% 	\caption[Xypre, modèle intermédiaire manipulé sur écran]{Gladys Brégeon jouant sur le Xypre, avec un modèle intermédiaire manipulé directement sur écran, durant la performance FIB\_R.}
% 	\label{fig:visual_representation:lemur}
% \end{wrapfigure}
