...
\begin{figure}[!htbp]
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\caption[Maintien d'un contrôle par un objet physique]{Maintien d'un contrôle par un objet physique. Tout type d'objet solide est captable par une surface multitouch IR; les surfaces capacitives nécessitent des objets conducteurs, voire un circuit électronique dédié et un traitement logiciel \textit{ad-hoc}.}
