...
Les représentations visuelle se prête à l'articulation des représentations visuelles liées à ces différents domaines et appelle à leur interaction. On peut être amené à ``accorder'' l'acoustique virtuelle d'une salle (sa réverbération), selon les fréquences d'une échelle musicale et donc exprimer sous forme de hauteur tonale des paramètres habituellement exprimés en termes de réponse impulsionnelle ou en temps de décroissance (T60).


L'usage de l'écran comme interface 
